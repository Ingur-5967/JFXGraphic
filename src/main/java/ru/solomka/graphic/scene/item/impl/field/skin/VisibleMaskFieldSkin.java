package ru.solomka.graphic.scene.item.impl.field.skin;
...
public class VisibleMaskFieldSkin extends TextFieldSkin {
    ...
    public VisibleMaskFieldSkin(PasswordField textField) {
        ...
        actionButton.setBackground(new Background(new BackgroundFill(Color.TRANSPARENT, CornerRadii.EMPTY, new Insets(10))));
